...
const UserNav = () => {
  ...
  return (
    <>
      <header className="bg-blue-800 p-4">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center space-x-4">
            <Link
              to="/product"
              className={`text-gray-400 mr-4 ${isActive("/product")}`}
            >
              Register Product
            </Link>
            <Link
              to="/req"
              className={`text-gray-400 mr-4 ${isActive("/req")}`}
            >
              Request Service
            </Link>
            <Link
              to="/sts"
              className={`text-gray-400 mr-4 ${isActive("/sts")}`}
            >
      ...
      {/* Notification */}
      {notification && (
        <div className="fixed top-0 right-0 p-4 bg-green-500 text-white rounded-md shadow-lg m-4">
          {notification}
        </div>
      )}
      ...
      >
        ...
        <div className="p-2">
          ...
          <Link
              ...
              className={`text-gray-400 mr-4 ${isActive("/servicecenter")}`}
            >
               <button  className="w-full py-2 px-4 bg-green-500 hover:bg-green-800 text-white rounded">
              Service History
              </button>
            </Link>
