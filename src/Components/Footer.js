...
function Footer() {
    ...
    return (
        <footer className="pt-10 bg-gray-100" id='contact'>
            <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                <div className="justify-between items-center gap-12 md:flex">
                    <div className="flex-1 max-w-lg">
                        <h3 className="text-dark text-2xl font-bold">
                            Post your Queries straight to our inbox.
                        </h3>
                    </div>
                ...
                <div className="flex-1 mt-16 space-y-6 justify-between sm:flex md:space-y-0 ">
                    {
                        footerNavs.map((item, idx) => (
                            <ul
                                ...
                                key={idx}
                            >
                                <h4 className="text-blue-900 font-semibold sm:pb-2">
                                    {item.label}
                                </h4>
                                {
                ...
                <div className="mt-10 py-10 border-t border-gray-700 items-center justify-between sm:flex">
                    <p className="text-gray-900">© 2024 Vashanth@Relevantz All rights reserved.</p>
                    <div className="flex items-center gap-x-6 text-gray-800 mt-6">
